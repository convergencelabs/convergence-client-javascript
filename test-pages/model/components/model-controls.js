...
<div class="card">
  <div class="card-body">
    ...
    <div class="input-group mb-3">
      <button class="btn btn-primary" :disabled="!enabled || model !== null" v-on:click="openModel">Open Model</button>
    ...
    <div class="input-group mb-3">
      <button class="btn btn-primary" :disabled="!enabled" v-on:click="createModel">Create Model</button>
      <div class="input-group-prepend ml-3"><span class="input-group-text">Model Id</span></div>
      <input type="text" class="form-control" v-model="createModelId" v-bind:disabled="!enabled">
    </div>
   
    <div class="input-group mb-3">
      <button class="btn btn-primary" :disabled="!enabled" v-on:click="deleteModel">Delete Model</button>
      <div class="input-group-prepend ml-3"><span class="input-group-text">Model Id</span></div>
