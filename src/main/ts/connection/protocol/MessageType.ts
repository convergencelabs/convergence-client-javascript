export enum MessageType {
  ...
  USER_GROUPS_REQUEST = 203,
  USER_GROUPS_RESPONSE = 204,

  USER_GROUPS_FOR_USERS_REQUEST = 205,
  USER_GROUPS_FOR_USERS_RESPONSE = 206,
  ...
  GET_CLIENT_PERMISSIONS_REQUEST = 601,
  GET_CLIENT_PERMISSIONS_RESPONSE = 602,

  ADD_PERMISSIONS_REQUEST = 603,
  ADD_PERMISSIONS_RESPONSE = 604,

  REMOVE_PERMISSIONS_REQUEST = 605,
  REMOVE_PERMISSIONS_RESPONSE = 606,

  SET_PERMISSIONS_REQUEST = 607,
  SET_PERMISSIONS_RESPONSE = 608,

  GET_WORLD_PERMISSIONS_REQUEST = 609,
  GET_WORLD_PERMISSIONS_RESPONSE = 610,

  GET_ALL_USER_PERMISSIONS_REQUEST = 611,
  GET_ALL_USER_PERMISSIONS_RESPONSE = 612,

  GET_USER_PERMISSIONS_REQUEST = 613,
  GET_USER_PERMISSIONS_RESPONSE = 614,

  GET_ALL_GROUP_PERMISSIONS_REQUEST = 615,
  GET_ALL_GROUP_PERMISSIONS_RESPONSE = 616,

  GET_GROUP_PERMISSIONS_REQUEST = 617,
  GET_GROUP_PERMISSIONS_RESPONSE = 618,
