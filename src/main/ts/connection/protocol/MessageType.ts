export enum MessageType {
  ...
  PRESENCE_SET_STATE = 100,
  PRESENCE_CLEAR_STATE = 101,

  PRESENCE_STATE_SET = 102,
  PRESENCE_STATE_CLEARED = 103,

  PRESENCE_AVAILABILITY_CHANGED = 104,

  PRESENCE_REQUEST = 105,
  PRESENCE_RESPONSE = 106,

  PRESENCE_SUBSCRIBE_REQUEST = 107,
  PRESENCE_SUBSCRIBE_RESPONSE = 108,
  PRESENCE_UNSUBSCRIBE = 109
}
