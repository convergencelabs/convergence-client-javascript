export enum MessageType {
  ...
  JOIN_ROOM = 84,
  LEAVE_ROOM = 85,
  PUBLISH_CHAT_MESSAGE = 86,

  USER_JOINED_ROOM = 87,
  USER_LEFT_ROOM = 88,
  CHAT_MESSAGE_PUBLISHED = 89,

  MODELS_QUERY_REQUEST = 90,
  MODELS_QUERY_RESPONSE = 91,

  HISTORICAL_DATA_REQUEST = 92,
  HISTORICAL_DATA_RESPONSE = 93,

  HISTORICAL_OPERATIONS_REQUEST = 94,
  HISTORICAL_OPERATIONS_RESPONSE = 95,
}
