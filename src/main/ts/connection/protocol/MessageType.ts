enum MessageType {
  ...
  ACTIVITY_JOIN_REQUEST = 60,
  ACTIVITY_JOIN_RESPONSE = 61,

  ACTIVITY_LEAVE_REQUEST = 62,
  ACTIVITY_LEAVE_RESPONSE = 63,

  ACTIVITY_SESSION_JOINED = 64,
  ACTIVITY_SESSION_LEFT = 65,

  ACTIVITY_STATE_SET = 66,
  ACTIVITY_STATE_CLEARED = 67,
}
